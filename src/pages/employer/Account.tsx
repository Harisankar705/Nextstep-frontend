...
const Account = () => {
    ...
    return (
        ...
        <div className="w-[250px] bg-[#1A1A1A] h-screen fixed overflow-y-auto">
            <SideBar />
        </div>
                        ...
                        <div className="bg-[#2A2A2A] rounded-xl p-6">
                            ...
                            <ul className="space-y-4">
                                ...
                                <li className="flex items-center gap-4">
                                    ...
                                    <span className="text-gray-300 text:sm md:text-base">Founded {new Date(dateFounded).toLocaleDateString()}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
