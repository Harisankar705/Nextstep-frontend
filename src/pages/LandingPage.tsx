...
const LandingPage: React.FC = () => {
  const headerSlides: Array<{
    ...
    },
    {
      ...
      description:
        "Find the most skilled professional to drive your company's success",
      buttonText: (
        <span
          className="bg-blue text-white py-2 px-2 rounded"
  ...
  const settings = {
    ...
    appendDots: (dots: React.ReactNode) => (
      <div
        style={{ bottom: "20px", display: "flex", justifyContent: "center" }}
      >
    ...
    <div className="relative w-full">
      ...
      <Slider {...settings}>
        {headerSlides.map((slide, index) => (
          <div
            key={index}
            className={`min-h-screen w-full ${slide.backgroundClass} text-white`}
          >
            ...
            <div className="container max-w-[1100px] mx-auto px-4 py-12 min-h-screen">
              <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
                ...
                <div className="hidden lg:block">
                  <img
                    src={slide.image}
                    alt={`${slide.buttonText} illustration`}
      ...
      <section className="bg-[#1e1c29] py-16">
        <div className="container max-w-[1100px] mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Join thousands of job seekers who have found success through our
            platform.
          </p>
